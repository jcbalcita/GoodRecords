...
Review.create!(user_id: 1, album_id: 1, body: "Excellent album.", rating: 5)
Review.create!(user_id: 1, album_id: 2, body: "Not bad.", rating: 5)
...
Crate.create!(user_id: 1, name: "Rock")
Crate.create!(user_id: 1, name: "Hip-Hop")
Crate.create!(user_id: 1, name: "Country")
